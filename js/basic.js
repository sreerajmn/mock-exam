...
function addquestion(quid,qid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "index.php/exam/add_qid/"+quid+'/'+qid,
		success: function(data){
...
window.location=base_url+"index.php/exam/up_question/"+global_quid+"/"+global_qid+"/"+npos;
}else{
var npos=parseInt(pos)-parseInt(global_opos);
window.location=base_url+"index.php/exam/down_question/"+global_quid+"/"+global_qid+"/"+npos;
}
}
...
function no_q_available(lid){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "index.php/exam/no_q_available/"+cid+'/'+lid,
		success: function(data){
...
function setIndividual_time(cqn='0'){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "index.php/exam/set_ind_time",
		success: function(data){
...
function submit_exam(){
	...
	setTimeout(function(){
	window.location=base_url+"index.php/exam/submit_exam/";
	},3000);
}
...
function assign_score(rid,qno,score){
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "index.php/exam/assign_score/"+rid+'/'+qno+'/'+score,
		success: function(data){
