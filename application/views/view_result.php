...
<tr><td><?php echo $this->lang->line('exam_name');?></td><td><?php echo $result['exam_name'];?></td></tr>
...
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: '<?php echo $this->lang->line('top_10_result');?> <?php echo $result['exam_name'];?>',
          hAxis: {title: '<?php echo $this->lang->line('exam');?>(<?php echo $this->lang->line('user');?>)', titleTextStyle: {color: 'red'}}
        };
