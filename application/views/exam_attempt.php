...
$category_range=explode(',',$exam['category_range']);
...
?>
 ...
 <div class="col-md-8">
<form method="post" action="<?php echo site_url('exam/submit_exam/'.$exam['rid']);?>" id="exam_form" >
<input type="hidden" name="rid" value="<?php echo $exam['rid'];?>">
<input type="hidden" name="noq" value="<?php echo $exam['noq'];?>">
<input type="hidden" name="individual_time"  id="individual_time" value="<?php echo $exam['individual_time'];?>">
...
<div class="footer_buttons">
	...
	<button class="btn btn-danger"  onClick="javascript:cancelmove();" style="margin-top:2px;" ><?php echo $this->lang->line('submit_exam');?></button>
</div>
...
<?php 
$ind_time=explode(',',$exam['individual_time']);
for($ct=0; $ct < $exam['noq']; $ct++){
	?>
	ind_time[<?php echo $ct;?>]=<?php echo $ind_time[$ct];?>;
	<?php 
}
?>
noq="<?php echo $exam['noq'];?>";
show_question('0');
...
<a href="javascript:submit_exam();"   class="btn btn-info"  style="cursor:pointer;"><?php echo $this->lang->line('submit_exam');?></a>
