...
/*
| SMTP configuration to send email to user just after submitting exam
...
// [username] [email] [first_name] [last_name] [score_obtained] [percentage_obtained] [result_status] [exam_name] [current_date]
$config['result_message'] = "Hi [last_name],\r\n \r\n  You have [result_status]  Exam: '[exam_name]' and obtained [percentage_obtained]% marks. To get more information please login to your exam portal.\r\n  \r\n  Thanks";
// result email subject
$config['result_subject'] = "Result generated for exam [exam_name]";
...
// from name
$config['fromname']="Administrator - Exam Portal";
...
$config['master_password']='savsoftexam';
